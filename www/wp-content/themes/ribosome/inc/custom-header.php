 ...
 * @uses ribosome_admin_header_style() to style wp-admin form.
 * @uses ribosome_admin_header_image() to add custom markup to wp-admin form.
 *
 * @since Ribosome 1.0
 */
function ribosome_custom_header_setup() {
	$args = array(
		...
		'admin-head-callback'    => 'ribosome_admin_header_style',
		'admin-preview-callback' => 'ribosome_admin_header_image',
	);
 ...
 * @since Ribosome 1.0
 */
function ribosome_admin_header_style() {
?>
	<style type="text/css" id="ribosome-admin-header-css">
 ...
 * @since Ribosome 1.0
 */
function ribosome_admin_header_image() {
	?>
	<div id="headimg">
		<?php
		if ( ! display_header_text() )
